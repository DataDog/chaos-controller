...
func main() {
	...
	image := os.Getenv(helpers.ChaosFailureInjectionImageVariableName)
	if image == "" {
		log.Error(nil, fmt.Sprintf("the %s variable must be set", helpers.ChaosFailureInjectionImageVariableName))
		os.Exit(1)
	}
