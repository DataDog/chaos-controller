...
func (_m *MockFileWriter) Write(path string, mode fs.FileMode, data string) error {
...
// MockFileWriter_Write_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Write'
type MockFileWriter_Write_Call struct {
	*mock.Call
}
...
//   - mode fs.FileMode
//   - data string
func (_e *MockFileWriter_Expecter) Write(path interface{}, mode interface{}, data interface{}) *MockFileWriter_Write_Call {
	return &MockFileWriter_Write_Call{Call: _e.mock.On("Write", path, mode, data)}
}

func (_c *MockFileWriter_Write_Call) Run(run func(path string, mode fs.FileMode, data string)) *MockFileWriter_Write_Call {
...
func (_c *MockFileWriter_Write_Call) Return(_a0 error) *MockFileWriter_Write_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockFileWriter_Write_Call) RunAndReturn(run func(string, fs.FileMode, string) error) *MockFileWriter_Write_Call {
	_c.Call.Return(run)
	return _c
}
