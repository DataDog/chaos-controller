...
func (_e *ManagerMock_Expecter) Enter() *ManagerMock_Enter_Call {
	return &ManagerMock_Enter_Call{Call: _e.mock.On("Enter")}
}
...
func (_c *ManagerMock_Enter_Call) Return(_a0 error) *ManagerMock_Enter_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_e *ManagerMock_Expecter) Exit() *ManagerMock_Exit_Call {
	return &ManagerMock_Exit_Call{Call: _e.mock.On("Exit")}
}
...
func (_c *ManagerMock_Exit_Call) Return(_a0 error) *ManagerMock_Exit_Call {
	_c.Call.Return(_a0)
	return _c
}
