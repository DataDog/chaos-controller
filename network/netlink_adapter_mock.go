...
func (_m *NetlinkAdapterMock) LinkList() ([]NetlinkLink, error) {
	ret := _m.Called()
...
func (_e *NetlinkAdapterMock_Expecter) LinkList() *NetlinkAdapterMock_LinkList_Call {
	return &NetlinkAdapterMock_LinkList_Call{Call: _e.mock.On("LinkList")}
}

func (_c *NetlinkAdapterMock_LinkList_Call) Run(run func()) *NetlinkAdapterMock_LinkList_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *NetlinkAdapterMock_LinkList_Call) RunAndReturn(run func() ([]NetlinkLink, error)) *NetlinkAdapterMock_LinkList_Call {
	_c.Call.Return(run)
	return _c
}
