...
func (in *DisruptionSpec) DeepCopyInto(out *DisruptionSpec) {
	*out = *in
	...
	if in.HTTP != nil {
		...
		*out = make(HTTPDisruptionSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPDisruption) DeepCopyInto(out *HTTPDisruption) {
	*out = *in
	if in.Domains != nil {
		in, out := &in.Domains, &out.Domains
		*out = make([]TargetDomain, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPDisruption.
func (in *HTTPDisruption) DeepCopy() *HTTPDisruption {
	if in == nil {
		return nil
	}
	out := new(HTTPDisruption)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in HTTPDisruptionSpec) DeepCopyInto(out *HTTPDisruptionSpec) {
	{
		in := &in
		*out = make(HTTPDisruptionSpec, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPDisruptionSpec.
func (in HTTPDisruptionSpec) DeepCopy() HTTPDisruptionSpec {
	if in == nil {
		return nil
	}
	out := new(HTTPDisruptionSpec)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequestField) DeepCopyInto(out *RequestField) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestField.
func (in *RequestField) DeepCopy() *RequestField {
	if in == nil {
		return nil
	}
	out := new(RequestField)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetDomain) DeepCopyInto(out *TargetDomain) {
	*out = *in
	if in.Header != nil {
		in, out := &in.Header, &out.Header
		*out = make([]RequestField, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetDomain.
func (in *TargetDomain) DeepCopy() *TargetDomain {
	if in == nil {
		return nil
	}
	out := new(TargetDomain)
	in.DeepCopyInto(out)
	return out
}
