...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PortTypes) DeepCopyInto(out *PortTypes) {
	*out = *in
	if in.HTTPS != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PortTypes.
func (in *PortTypes) DeepCopy() *PortTypes {
	if in == nil {
		return nil
	}
	out := new(PortTypes)
