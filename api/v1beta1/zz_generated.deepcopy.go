...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkDisruptionNodeSpec) DeepCopyInto(out *NetworkDisruptionNodeSpec) {
	*out = *in
	if in.Selector != nil {
		in, out := &in.Selector, &out.Selector
		*out = make(labels.Set, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkDisruptionNodeSpec.
func (in *NetworkDisruptionNodeSpec) DeepCopy() *NetworkDisruptionNodeSpec {
	if in == nil {
		return nil
	}
	out := new(NetworkDisruptionNodeSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkDisruptionPodSpec) DeepCopyInto(out *NetworkDisruptionPodSpec) {
	*out = *in
	if in.Selector != nil {
		in, out := &in.Selector, &out.Selector
		*out = make(labels.Set, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkDisruptionPodSpec.
func (in *NetworkDisruptionPodSpec) DeepCopy() *NetworkDisruptionPodSpec {
	if in == nil {
		return nil
	}
	out := new(NetworkDisruptionPodSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkDisruptionSpec) DeepCopyInto(out *NetworkDisruptionSpec) {
	*out = *in
	...
	if in.Pods != nil {
		...
		*out = make([]NetworkDisruptionPodSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Nodes != nil {
		...
		*out = make([]NetworkDisruptionNodeSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
