...
const (
	...
	// ScheduledAtAnnotation is the annotation key for the scheduled time of the disruption when it is created from DisruptionCron.
	ScheduledAtAnnotation = GroupName + "/scheduled-at"

	// UserAnnotation is the annotation key that stores the username of the user who created the parent resource (DisruptionCron).
	UserAnnotation = GroupName + "/user"
	// UserGroupsAnnotation is the annotation key that stores the user groups of the individual who created the parent resource (DisruptionCron).
