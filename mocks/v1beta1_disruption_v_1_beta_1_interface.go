...
import (
	v1beta1 "github.com/DataDog/chaos-controller/clientset/v1beta1"
...
func (_m *DisruptionV1Beta1InterfaceMock) Disruptions(namespace string) v1beta1.DisruptionInterface {
	ret := _m.Called(namespace)

	var r0 v1beta1.DisruptionInterface
	if rf, ok := ret.Get(0).(func(string) v1beta1.DisruptionInterface); ok {
		r0 = rf(namespace)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1beta1.DisruptionInterface)
		}
	}
...
func (_c *DisruptionV1Beta1InterfaceMock_Disruptions_Call) Return(_a0 v1beta1.DisruptionInterface) *DisruptionV1Beta1InterfaceMock_Disruptions_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DisruptionV1Beta1InterfaceMock_Disruptions_Call) RunAndReturn(run func(string) v1beta1.DisruptionInterface) *DisruptionV1Beta1InterfaceMock_Disruptions_Call {
	_c.Call.Return(run)
	return _c
}
