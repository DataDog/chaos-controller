...
func (_m *DisruptionInterfaceMock) Create(ctx context.Context, disruption *v1beta1.Disruption) (*v1beta1.Disruption, error) {
	ret := _m.Called(ctx, disruption)

	var r0 *v1beta1.Disruption
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta1.Disruption) (*v1beta1.Disruption, error)); ok {
		return rf(ctx, disruption)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *v1beta1.Disruption) *v1beta1.Disruption); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *v1beta1.Disruption) error); ok {
...
func (_c *DisruptionInterfaceMock_Create_Call) Run(run func(ctx context.Context, disruption *v1beta1.Disruption)) *DisruptionInterfaceMock_Create_Call {
...
func (_c *DisruptionInterfaceMock_Create_Call) RunAndReturn(run func(context.Context, *v1beta1.Disruption) (*v1beta1.Disruption, error)) *DisruptionInterfaceMock_Create_Call {
	_c.Call.Return(run)
	return _c
}
