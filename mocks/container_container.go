...
import (
	container "github.com/DataDog/chaos-controller/container"
...
func (_m *ContainerMock) Runtime() container.Runtime {
	ret := _m.Called()

	var r0 container.Runtime
	if rf, ok := ret.Get(0).(func() container.Runtime); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(container.Runtime)
		}
	}
...
func (_c *ContainerMock_Runtime_Call) Return(_a0 container.Runtime) *ContainerMock_Runtime_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ContainerMock_Runtime_Call) RunAndReturn(run func() container.Runtime) *ContainerMock_Runtime_Call {
	_c.Call.Return(run)
	return _c
}
