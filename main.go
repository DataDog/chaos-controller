...
func main() {
	...
	kubeInformerFactory := kubeinformers.NewSharedInformerFactoryWithOptions(informerClient, time.Second*30, kubeinformers.WithNamespace(cfg.Injector.ServiceAccount.Namespace))
